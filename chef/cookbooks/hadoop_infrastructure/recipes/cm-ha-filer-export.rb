...
Chef::Log.info("HI - BEGIN hadoop_infrastructure:cm-ha-filer-export") if debug
...
shared_edits_export_options = node[:hadoop_infrastructure][:ha][:shared_edits_export_options]
...
# End recipe
#######################################################################
Chef::Log.info("HI - END hadoop_infrastructure:cm-ha-filer-export") if debug
